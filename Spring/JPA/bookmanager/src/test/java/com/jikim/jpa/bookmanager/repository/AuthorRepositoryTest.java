...
class AuthorRepositoryTest {
    ...
    @Transactional
    void manyToManyTest() {
        Book book1 = createBook("책1");
        Book book2 = createBook("책2");
        Book book3 = createBook("개발 책1");
        Book book4 = createBook("개발 책2");

        Author author1 = createAuthor("martin");
        Author author2 = createAuthor("steve");
...
//        author1.addBook(book2, book3, book4);
        ...
        BookAndAuthor bookAndAuthor1 = createBookAndAuthor(book1, author1);
        BookAndAuthor bookAndAuthor2 = createBookAndAuthor(book2, author2);
        BookAndAuthor bookAndAuthor3 = createBookAndAuthor(book3, author1);
        BookAndAuthor bookAndAuthor4 = createBookAndAuthor(book3, author2);
        BookAndAuthor bookAndAuthor5 = createBookAndAuthor(book4, author1);
        BookAndAuthor bookAndAuthor6 = createBookAndAuthor(book4, author2);
...
//        System.out.println("books through author : " + authorRepository.findAll().get(0).getBooks());
    ...
    private BookAndAuthor createBookAndAuthor(Book book, Author author) {
